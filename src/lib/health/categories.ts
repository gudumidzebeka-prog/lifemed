...
const CATEGORY_DEFAULT_TIMELINE_TYPE: Partial<Record<string, TimelineEvent["type"]>> = {
  ...
  endocrinology: "doctor_visit",
  gastroenterology: "doctor_visit",
  pulmonology: "doctor_visit",
  rheumatology: "doctor_visit",
  psychiatry: "doctor_visit",
  psychology: "doctor_visit",
  orthopedics: "doctor_visit",
  traumatology: "doctor_visit",
  ophthalmology: "doctor_visit",
  otorhinolaryngology: "doctor_visit",
  urology: "doctor_visit",
  gynecology: "doctor_visit",
  andrology: "doctor_visit",
  allergology: "doctor_visit",
  oncology: "doctor_visit",
  hematology: "doctor_visit",
  "infectious-disease": "doctor_visit",
  pathology: "doctor_visit",
  pediatrics: "doctor_visit",
  rehabilitation: "doctor_visit",
  toxicology: "doctor_visit",
  genetics: "doctor_visit",
  "plastic-surgery": "surgery",
  stomatology: "doctor_visit",
  somnology: "doctor_visit",
  nutrition: "doctor_visit",
};
